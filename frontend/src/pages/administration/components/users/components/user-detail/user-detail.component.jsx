            ...
            <div className="user-detail-fields-container">
                ...
                <div className="user-detailed-field">
                    ...
                    <Typography className="description">
                        { user?.role === ROLETYPE.ADMIN ? strings.roles.admin : strings.roles.user }
                    </Typography>
                </div>
...

                {
                    ...
                    <div className="user-detailed-field-access">
                        ...
                        <Stack
                            ...
                            spacing={2}
                            >
                            { user?.divisions.filter((division) => division.type !== DIVISION_TYPE.common_area).map((division) => <Chip key={division.uuid} label={division.name} variant="outlined" />)}
                        </Stack>
                    </div>
